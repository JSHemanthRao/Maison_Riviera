export const watchGalleries: Record<string, string[]> = {
  "astronomia": [
  ...
  "gotham-city": [
    "/images/watches/gotham-city-hero.webp",
  ...
  "astronomia-art-india": [
    "/images/watches/astronomia-art-india-hero.webp",
  ...
  "brilliant-skeleton": [
    "/images/watches/brilliant-skeleton-hero.webp",
  ...
  "astronomia-clarity-dragon": [
    "/images/watches/astronomia-clarity-dragon-hero.webp",
