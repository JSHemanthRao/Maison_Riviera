...
if (!(Test-Path "$dir\astronomia-clarity-dragon-hero.webp")) {
    Copy-Item "$dir\Astronomia Solar Icy Blue Baguette Sapphires.jpg" "$dir\astronomia-clarity-dragon-hero.webp"
}
if (!(Test-Path "$dir\astronomia-art-india-hero.webp")) {
    Copy-Item "$dir\Astronomia Art India.jpg" "$dir\astronomia-art-india-hero.webp"
}
if (!(Test-Path "$dir\brilliant-skeleton-hero.webp")) {
    Copy-Item "$dir\Brilliant Skeleton.jpg" "$dir\brilliant-skeleton-hero.webp"
}
